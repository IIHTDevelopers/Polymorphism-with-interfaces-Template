...
public class FunctionalTest {
	...
	String filePath = "src/main/java/com/yaksha/assignment/PolymorphismWithInterfacesAssignment.java";
	...
	public void testMethodOperationsOnly() throws Exception {
		...
		boolean result = autoGrader.testPolymorphismWithInterfaces(filePath);
